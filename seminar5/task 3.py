...
with open('file_encode.txt', 'w') as data:
    data.write('434745') # заменяем на буквы -тоже работает
...
print('декодировка: \t' + decoded_string)
print('кодировка: \t' + rle_encode(decoded_string))
print(f'коофициент сжатия: \t{round(len(decoded_string) / len(encoded_string), 1)}')